class Admin::MaterialsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @material.save
        format.html { redirect_to [:admin, @material], notice: t(:message_success_create) }
  ...
  def update
    respond_to do |format|
      if @material.update(material_params)
        format.html { redirect_to [:admin, @material], notice: t(:message_success_update) }
