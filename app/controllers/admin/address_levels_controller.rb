  ...
  def create
    ...
    respond_to do |format|
      if @address_level.save
        format.html { redirect_to [:admin, @address_level], notice: t(:message_success_create) }
  ...
  def update
    respond_to do |format|
      if @address_level.update(address_level_params)
        format.html { redirect_to [:admin, @address_level], notice: t(:message_success_update) }
