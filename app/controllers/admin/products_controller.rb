class Admin::ProductsController < Admin::AdminController
  ...
  def product_params
    params.require(:product).permit(:company_id, :product_category_id, :title, :price, :enable, speciality_category_ids: [], product_content_attributes: [:content], product_pictures_attributes: [:picture])
  end
end
