class Admin::SpecialitiesController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @speciality.save
        format.html { redirect_to [:admin, @speciality], notice: t(:message_success_create) }
  ...
  def update
    respond_to do |format|
      if @speciality.update(speciality_params)
        format.html { redirect_to [:admin, @speciality], notice: t(:message_success_update) }
  ...
  def speciality_params
    params.require(:speciality).permit(:title, :speciality_category_id, :enable, speciality_picture_attributes: [:picture])
  end
end
