...
Talk.create!(id: 12, user_id: 1, title: 'IIS제한 있었네요', content: '
...
Talk.create!(id: 13, user_id: 1, title: '자동테스트를 써야 프로그래머입니다.', content: '
...
Talk.create!(id: 14, user_id: 1, title: '가성비 가상서버 마련하세요', content: '
...
Talk.create!(user_id: 1, title: '알리익스프레스로 주문해봤어요',
...
Talk.create!(user_id: 1, title: '아이맥 SSD로 바꾸니 날라다니네요',
...
Talk.create!( user_id: 1, title: '최고로 재미있는 게임 추천합니다.',
